...
const actions = {
  ...
  setUser({
    ...
    user.attributes.humanityUsername = user.attributes['custom:humanityLogin'].split(',')[0]
    user.attributes.humanityPassword = user.attributes['custom:humanityLogin'].split(',')[1]
    user.attributes.humanityID = user.attributes['custom:humanityLogin'].split(',')[2]
