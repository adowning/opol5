...
exports.handler=function(event,context,callback){
    ...
    url = event.Records[0].Sns.Message.default.TranscriptionJob.Transcript.TranscriptFileUri;
    s3url = event.Records[0].Sns.Message.default.TranscriptionJob.Media.MediaFileUri;
