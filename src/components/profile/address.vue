...
export default {
	...
	watch: {
		...
		addressProp: function() {
			...
			if (JSON.parse(JSON.stringify(this.address)) === 'none') {
				this.address.line = 'NA'
				this.address.city = 'NA'
				this.address.state = 'NA'
				this.address.zipcode = 'NA'
				this.address.country = 'NA'
				this.addressUpdate =
        JSON.parse(
