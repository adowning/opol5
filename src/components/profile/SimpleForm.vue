      ...
      <v-card ref="form">
        <v-card-text>
          <v-text-field
            ...
            :rules="[() => !!profile.firstName || 'This field is required']"
          ...
          ></v-text-field>
           <v-text-field
            ...
            :rules="[() => !!profile.lastName || 'This field is required']"
            :error-messages="errorMessages"
            label="Downing"
          ...
          <v-text-field
            ref="city"
            :disabled="disabled"
            :rules="[() => !!profile.city || 'This field is required', addressCheck]"
          ...
          <v-text-field
            ...
            :rules="[() => !!profile.state || 'This field is required']"
          ...
          <v-text-field
            ref="zip"
            :disabled="disabled"
            :rules="[() => !!profile.zip || 'This field is required']"
            v-model="profile.zip"
...
export default {
	...
	props: ['path', 'fields'],
	computed: {
		userId: function() { return this.$store.state.auth.user.username }
	},
